...
def gatavs():
    if request.method=='POST':
        return render_template('gatavs.html', stunduskaits=request.form.getlist('stunduskaits[]'), vards=request.form['vards'], uzvards=request.form['uzvards'], programma=request.form['programma'], masivs=request.form.getlist('izvele[]'))
    else:
